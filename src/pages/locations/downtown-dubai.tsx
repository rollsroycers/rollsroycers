          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              {[
                ...
                { href: '/locations/difc', name: t(`locations.difc.nav`) },
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              {[
                ...
                { href: '/services/airport-transfer', name: t(`services.airport.title`) },
              ].map((s) => (
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale || 'en', ['common', 'comparefleet', 'lc_downtown', 'lc_shared', 'navigation', 'seo_locations'])),
    },
  }
}