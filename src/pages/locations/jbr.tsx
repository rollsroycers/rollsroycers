        ...
        <section className="py-16 bg-gradient-to-b from-rolls-navy to-rolls-black">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              {[
                { href: '/locations/dubai-marina', name: 'Dubai Marina' },
                { href: '/locations/palm-jumeirah', name: 'Palm Jumeirah' },
            ...
            <h3 className="text-2xl font-bold text-white text-center mb-6">Popular Services at JBR</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              {[
                { href: '/services/photoshoot', name: 'Photoshoot Service' },
                { href: '/services/tours', name: 'Dubai City Tours' },
                { href: '/services/birthday', name: 'Birthday Celebrations' },
              ].map((s) => (
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale || 'en', ['common', 'comparecontent', 'lc_jbr', 'lc_shared', 'navigation', 'seo_locations'])),
    },
  }
}