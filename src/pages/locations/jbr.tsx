        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-28 sm:py-24">
          <div className="absolute inset-0">
            <HeroBackgroundVideo
              ...
              poster="/images/videos/Rolls_Royce_defines_what_Luxury_cars_mean-thumb.jpg"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              {[
                ...
                { href: '/locations/palm-jumeirah', name: t(`locations.palmJumeirah.nav`) },
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              {[
                ...
                { href: '/services/birthday', name: t(`services.birthday.title`) },
              ].map((s) => (
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  return {
    props: {
      ...(await serverSideTranslations(locale || 'en', ['common', 'comparefleet', 'lc_jbr', 'lc_shared', 'navigation', 'seo_locations', 'weatherrec'])),
    },
  }
}